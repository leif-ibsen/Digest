...
class HMACTest: XCTestCase {
    ...
    static let key1 = Base64.hex2bytes("0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b")!
    static let data1 = Base64.hex2bytes("4869205468657265")!
    static let key2 = Base64.hex2bytes("4a656665")!
    static let data2 = Base64.hex2bytes("7768617420646f2079612077616e7420666f72206e6f7468696e673f")!
    static let key3 = Base64.hex2bytes("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")!
    static let data3 = Base64.hex2bytes("dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd")!
    static let key4 = Base64.hex2bytes("0102030405060708090a0b0c0d0e0f10111213141516171819")!
    static let data4 = Base64.hex2bytes("cdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcd")!
    static let key6 = Base64.hex2bytes(
        "")!
    static let data6 = Base64.hex2bytes(
        "54657374205573696e67204c6172676572205468616e20426c6f636b2d53697a65204b6579202d2048617368204b6579204669727374")!
    static let key7 = Base64.hex2bytes(
        "")!
    static let data7 = Base64.hex2bytes(

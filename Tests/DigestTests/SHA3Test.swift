...
final class SHA3Test: XCTestCase {
    ...
    func test224() throws {
        ...
        md.update(Util.s1)
        XCTAssertEqual(Util.bytes2hex(md.digest()), "6b4e03423667dbb73b6e15454f0eb1abd4597f9a1b078e3f5b5a6bc7")
        md.update(Util.s2)
        XCTAssertEqual(Util.bytes2hex(md.digest()), "e642824c3f8cf24ad09234ee7d3c766fc9a3a5168d0c94ad73b46fdf")
        md.update(Util.s3)
        XCTAssertEqual(Util.bytes2hex(md.digest()), "8a24108b154ada21c9fd5574494479ba5c7e7ab76ef264ead0fcce33")
        md.update(Util.s4)
        XCTAssertEqual(Util.bytes2hex(md.digest()), "543e6868e1666c1a643630df77367ae5a62a85070a51c14cbf665cbc")
        md.update(Util.s5)
        XCTAssertEqual(Util.bytes2hex(md.digest()), "d69335b93325192e516a912e6d19a15cb51c6ed5c15243e7a7fd653c")
    }
    ...
    func test384() throws {
        ...
        md.update(Util.s1)
        XCTAssertEqual(Util.bytes2hex(md.digest()), "0c63a75b845e4f7d01107d852e4c2485c51a50aaaa94fc61995e71bbee983a2ac3713831264adb47fb6bd1e058d5f004")
        md.update(Util.s2)
        XCTAssertEqual(Util.bytes2hex(md.digest()), "ec01498288516fc926459f58e2c6ad8df9b473cb0fc08c2596da7cf0e49be4b298d88cea927ac7f539f1edf228376d25")
        md.update(Util.s3)
        XCTAssertEqual(Util.bytes2hex(md.digest()), "991c665755eb3a4b6bbdfb75c78a492e8c56a22c5c4d7e429bfdbc32b9d4ad5aa04a1f076e62fea19eef51acd0657c22")
        md.update(Util.s4)
        XCTAssertEqual(Util.bytes2hex(md.digest()), "79407d3b5916b59c3e30b09822974791c313fb9ecc849e406f23592d04f625dc8c709b98b43b3852b337216179aa7fc7")
        md.update(Util.s5)
        XCTAssertEqual(Util.bytes2hex(md.digest()), "eee9e24d78c1855337983451df97c8ad9eedf256c6334f8e948d252d5e0e76847aa0774ddb90a842190d2c558b4b8340")
    }
